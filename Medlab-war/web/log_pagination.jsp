...
<html>
    <head>
        ...
        <title>Medlab | Log Pagination</title>
    ...
    <body>
        ...
        <div class ="header">
            <center><p class="header_title" id="pagination_title">LogFacade</p>
                <div>
                ...
                <table style="width:70%;">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">EJBS</th> 
                        </tr>
                    </thead>
                    <tbody>
                        <% List<Log> log = (Vector) request.getAttribute("log");
                            for (Log entry : log) {
