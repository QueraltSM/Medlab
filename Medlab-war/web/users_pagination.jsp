...
<html>
    <head>
        ...
        <title>Medlab | Users Pagination</title>
    ...
    <body>
        ...
        <div class ="header">
            <center><p class="header_title" id="pagination_title">UsersFacade</p>
                <div>
        ...
        <div class="wrapper">
            <div class="form-group" style="width:70%; margin: 0 auto; text-align:center;">
                <table style="width:70%;">
                    ...
                    <tbody>
                        <% List<Users> users = (Vector) request.getAttribute("users");
                            for (Users entry : users) {
                        %>
                        <tr>
                            <td><%=entry.getId()%></td>
