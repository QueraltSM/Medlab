                ...
                <div class="wrap-login100 p-t-0 p-b-100">
                    <form action="FrontController" class="login100-form validate-form">
                        ...
                        <div class="wrap-input100 validate-input m-b-10" data-validate = "Medical license number is invalid">
                            <input class="input100" type="text" id="license_number" name="license_number" placeholder="Medical License Number">
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                                <i class="fa fa-address-card"></i>
                            </span>
                        </div>
                        <div class="wrap-input100 validate-input m-b-10" data-validate = "First name is invalid">
                            <input class="input100" type="text" placeholder="First name" name="first_name" id="first_name" title="First name must contain between 3 and 40 characters long.">
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                                <i class="fa fa-user-md"></i>
                            </span>
                        </div>
                        <div class="wrap-input100 validate-input m-b-10" data-validate = "Last name is invalid">
                            <input class="input100" type="text" placeholder="Last name" name="last_name" id="last_name" title="Last name must contain between 3 and 40 characters long.">
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                                <i class="fa fa-user-md"></i>
                            </span>
                        ...
                        <div class="wrap-input100 validate-input m-b-10" data-validate = "Password is invalid">
                            <input class="input100" type="password" id="password" 
                                   name="password" placeholder="Password" title="Password must contain between 8 and 40 characters long, at least one digit, one lower case character and one upper case character.">
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
