...
<html>
    <head>
        ...
        <title>Medlab | Cases Pagination</title>
    ...
    <body>
        ...
        <div class ="header">
            <center><p class="header_title" id="pagination_title">CasesFacade</p>
                <div>
        ...
        <div class="wrapper">
            <div class="form-group" style="width:70%; margin: 0 auto; text-align:center;">
                <table style="width:70%;">
                    ...
                    <tbody>
                        <% List<Clinicalcases> cases = (Vector) request.getAttribute("cases");
                            for (Clinicalcases entry : cases) {
