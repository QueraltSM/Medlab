...
<html>
    <head>
        ...
        <title>Medlab | Create research</title>
    ...
    <body>
        ...
        <div class ="header">
            <center><p class="header_title">Create research</p></center>
        </div>
        <div class ="patient_data">
            <form action="FrontController" class="signup-form" enctype="multipart/form-data">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-input" id="description" name="description" rows="20" cols="50" style="height:auto" required></textarea>
                    </div>
                    <div class="form-group">
                        <label for="conclusions" class="label-title">Conclusions</label>
                        <textarea class="form-input" id="conclusions" name="conclusions" rows="20" cols="50" style="height:auto" required></textarea>
                    </div>
                    ...
                    <div class="form-footer">
                        <input name="command" type="hidden" value="AddResearchesCommand">
