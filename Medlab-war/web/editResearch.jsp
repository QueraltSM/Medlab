...
<html>
    <head>
        ...
        <title>Medlab | Edit research</title>
    ...
    <body onload='setSpeciality("<%=research.getSpeciality().getType()%>")'>
        <jsp:include page="header.jsp" /> 
        <div class ="header">
            <center><p class="header_title">Edit research</p></center>
        </div>
            ...
            <form action="FrontController" class="signup-form">
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" class="form-input" value="<%=research.getTitle()%>" required>
                    </div>
                    <div class="form-group">
                        <label for="description" class="label-title">Description</label>
                        <textarea class="form-input" id="description" name="description" rows="20" cols="50" style="height:auto" required><%=research.getDescription()%></textarea>
                    </div>
                    <div class="form-group">
                        <label for="conclusions" class="label-title">Conclusions</label>
                        <textarea class="form-input" id="conclusions" name="conclusions" rows="20" cols="50" style="height:auto" required><%=research.getConclusions()%></textarea>
                    </div>
                    ...
                    <div class="form-footer">
                        <input name="command" type="hidden" value="ModifyResearchesCommand">
                        <input name="id" type="hidden" value="<%=research.getId()%>">
