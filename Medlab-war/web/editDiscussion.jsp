...
<html>
    ...
    <title>Medlab | Edit discussion</title>
...
<body onload='setSpeciality("<%=discussion.getSpeciality().getType()%>")'>
    <jsp:include page="header.jsp" /> 
    <div class ="header">
        <center><p class="header_title">Edit discussion</p></center>
    </div>
    <div class ="patient_data">
      ...
      <div class="form-body">
          ...
          <input type="text" id="title" name="title" class="form-input" value="<%=discussion.getTitle()%>" required>
        </div>
          <div class="form-group">
          <label for="description" class="label-title">Description</label>
          <textarea class="form-input" id="description" name="description" rows="4" cols="50" style="height:auto" required><%=discussion.getDescription()%></textarea>
        </div>
        ...
        <div class="form-footer">
            <input name="command" type="hidden" value="ModifyDiscussionsCommand">
            <input name="id" type="hidden" value="<%=discussion.getId()%>">
