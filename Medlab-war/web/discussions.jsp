                    ...
                    <div class="col-md-4">
                        <div class="post">
                            ...
                            <div class="post-body">
                                ...
                                <h3 class="post-title"><a href="FrontController?command=DiscussionsDetailsCommand&type=discussion&id=<% out.println(discussions.getId());%>"><% out.println(discussions.getTitle());%></a></h3>	
                            </div>
                        </div>
                    </div>       
                    <%if (i == count) {
