...
<html>
    <head>
        ...
        <title>Medlab | Cart Pagination</title>
            ...
            <center><p class="header_title" id="pagination_title">CartFacade</p>
                <div>
                    ...
                    <select onchange='setNewEntitySearch()' id="entity" class="form-input">
                        ...
                        <option value="carts" selected>Cart</option> 
        ...
        <div class="wrapper">
            <div class="form-group" style="width:70%; margin: 0 auto; text-align:center;">
                <table style="width:70%;">
                    ...
                    <tbody>
                        <% List<Cart> carts = (Vector) request.getAttribute("carts");
                            for (Cart entry : carts) {
                        %>
                        <tr>
                            <td><%=entry.getId()%></td>
                            <td><%=entry.getUserid().getFullname()%></td>
                        </tr>
                        <%}%>
                    </tbody>
                </table>
